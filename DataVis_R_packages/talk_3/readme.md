Rmarkdown_sample.Rmd, Rmarkdown_slides_sampe.Rmd and {shinyR/App_i, i = 1,2,3,4,5.} are about collecting what we have seen in talk 1 and 2, and putting them together into one HTML file or one Web application.
